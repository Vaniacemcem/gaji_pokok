...
# Golongan Ia
if tipe_pegawai == "Pegawai Negeri Sipil (PNS)" and golongan_pegawaii == "Golongan Ia" and 0 <= masa_kerjaa <= 1:
  st.warning ("Gaji Pokoknya adalah 1.685.700")

elif golongan_pegawaii == "Golongan Ia" and 2 <= masa_kerjaa <= 3:
  st,warning ("Gaji Pokoknya adalah 1.738.800")

elif golongan_pegawaii == "Golongan Ia" and 4 <= masa_kerjaa <= 5:
  st,warning ("Gaji Pokoknya adalah 1.793.500")
  
elif golongan_pegawaii == "Golongan Ia" and 6 <= masa_kerjaa <= 7:
