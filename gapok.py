...
tipe_pegawaii = st.selectbox(''':blue[Masukkan Tipe Pegawai]''', tipe_pegawai)
golongan_pegawaii = st.selectbox(''':blue[Masukkan Golongan]''', golongan_pegawai)
masa_kerjaa = st.selectbox(''':blue[Masukkan Masa Kerja (Dalam Tahun)]''',masa_kerja)
