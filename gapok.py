...
elif golongan_pegawai == "Golongan Ia" and 4 <= masa_kerjaa <= 5:
  st,warning ("Gaji Pokoknya adalah 1.793.500")
  
elif golongan_pegawai == "Golongan Ia" and 6 <= masa_kerjaa <= 7:
  st,warning ("Gaji Pokoknya adalah 1.850.000")

elif golongan_pegawai == "Golongan Ia" and 8 <= masa_kerjaa <= 9:
  st,warning ("Gaji Pokoknya adalah 1.908.300")

elif golongan_pegawai == "Golongan Ia" and 10 <= masa_kerjaa <= 11:
  st,warning ("Gaji Pokoknya adalah 1.968.400")
  
elif golongan_pegawai == "Golongan Ia" and 12 <= masa_kerjaa <= 13:
  st,warning ("Gaji Pokoknya adalah 2.030.400")

elif golongan_pegawai == "Golongan Ia" and 14 <= masa_kerjaa <= 15:
  st,warning ("Gaji Pokoknya adalah 2.094.300")

elif golongan_pegawai == "Golongan Ia" and 16 <= masa_kerjaa <= 17:
  st,warning ("Gaji Pokoknya adalah 2.160.300")
  
elif golongan_pegawai == "Golongan Ia" and 18 <= masa_kerjaa <= 19:
  st,warning ("Gaji Pokoknya adalah 2.228.300")

elif golongan_pegawai == "Golongan Ia" and 20 <= masa_kerjaa <= 21:
  st,warning ("Gaji Pokoknya adalah 2.298.500")

elif golongan_pegawai == "Golongan Ia" and 22 <= masa_kerjaa <= 23:
...
# Golongan Ib  
elif golongan_pegawai == "Golongan Ib" and 3 <= masa_kerjaa <= 4:
  st,warning ("Gaji Pokoknya adalah 1.840.800")
  
elif golongan_pegawai == "Golongan Ib" and 5 <= masa_kerjaa <= 6:
  st,warning ("Gaji Pokoknya adalah 1.898.800")
  
elif golongan_pegawai == "Golongan Ib" and 7 <= masa_kerjaa <= 8:
  st,warning ("Gaji Pokoknya adalah 1.958.600")
  
elif golongan_pegawai == "Golongan Ib" and 9 <= masa_kerjaa <= 10:
  st,warning ("Gaji Pokoknya adalah 2.020.300")
  
elif golongan_pegawai == "Golongan Ib" and 11 <= masa_kerjaa <= 12:
  st,warning ("Gaji Pokoknya adalah 2.083.900")
  
elif golongan_pegawai == "Golongan Ib" and 13 <= masa_kerjaa <= 14:
  st,warning ("Gaji Pokoknya adalah 2.149.600")
  
elif golongan_pegawai == "Golongan Ib" and 15 <= masa_kerjaa <= 16:
  st,warning ("Gaji Pokoknya adalah 2.217.300")
  
elif golongan_pegawai == "Golongan Ib" and 17 <= masa_kerjaa <= 18:
  st,warning ("Gaji Pokoknya adalah 2.287.100")
  
elif golongan_pegawai == "Golongan Ib" and 19 <= masa_kerjaa <= 20:
  st,warning ("Gaji Pokoknya adalah 2.359.100")
  
elif golongan_pegawai == "Golongan Ib" and 21 <= masa_kerjaa <= 22:
  st,warning ("Gaji Pokoknya adalah 2.433.400")
  
elif golongan_pegawai == "Golongan Ib" and 23 <= masa_kerjaa <= 24:
  st,warning ("Gaji Pokoknya adalah 2.510.100")
  
elif golongan_pegawai == "Golongan Ib" and 25 <= masa_kerjaa <= 26:
  st,warning ("Gaji Pokoknya adalah 2.589.100")
  
elif golongan_pegawai == "Golongan Ib" and 27 <= masa_kerjaa <= 27:
  st,warning ("Gaji Pokoknya adalah 2.670.700")
  
# Golongan Ic 
elif golongan_pegawai == "Golongan Ia" and 3 <= masa_kerjaa <= 4:
  st,warning ("Gaji Pokoknya adalah 2.522.600")
